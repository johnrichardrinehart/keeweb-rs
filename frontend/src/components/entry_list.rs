...
fn get_standard_icon(icon_id: Option<u32>, fallback: &str) -> String {
    match icon_id {
        ...
        // 9: Settings/Person with gear (the one you highlighted!)
        Some(9) => svg_icon(
            "M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm-2 8v-1c0-.9.6-1.7 1.5-1.93.38-.1.77-.07 1.13.06l.37.15.37-.15c.36-.13.75-.16 1.13-.06.9.23 1.5 1.03 1.5 1.93v1H10zm9.74-4.51l-.54-.44c.07-.36.1-.74.1-1.12 0-.38-.03-.76-.1-1.12l.54-.44c.32-.26.38-.72.14-1.06l-.8-1.38c-.24-.42-.74-.56-1.16-.36l-.62.3c-.52-.42-1.12-.76-1.76-1V8.44c0-.46-.34-.86-.8-.94l-1.58-.27c-.46-.08-.9.2-1.04.64l-.22.68c-.68.1-1.32.32-1.9.64l-.58-.38c-.38-.26-.9-.18-1.18.18l-1 1.22c-.3.36-.26.88.08 1.2l.48.44c-.12.42-.18.86-.18 1.32s.06.9.18 1.32l-.48.44c-.34.32-.38.84-.08 1.2l1 1.22c.28.36.8.44 1.18.18l.58-.38c.58.32 1.22.54 1.9.64l.22.68c.14.44.58.72 1.04.64l1.58-.27c.46-.08.8-.48.8-.94v-.74c.64-.24 1.24-.58 1.76-1l.62.3c.42.2.92.06 1.16-.36l.8-1.38c.24-.34.18-.8-.14-1.06z",
        ),
        // 10: Wrench/Tool
        Some(10) => svg_icon(
        ...
        // 61: Camera
        Some(61) => svg_icon(
            "M12 15c1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3 1.34 3 3 3zm8-9h-3.17l-1.86-2H9.03L7.17 6H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2z",
        ),
        // 62: Wifi
        Some(62) => svg_icon(
